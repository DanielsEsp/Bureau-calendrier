             ...
             if (httpCode == HTTP_CODE_OK) {
                 ...
                 if (!error) {
                    ...
                    Serial.println(String(doc["current"]["time"])); Serial.println(); 
                     ...
                     if (Direction > 337.5 || Direction <= 22.5) { vient_De = "   Nord"; }
                     if (Direction > 22.5 && Direction <= 67.5) { vient_De = "  Nord Est"; }
                     if (Direction > 67.5 && Direction <= 112.5) { vient_De = "    Est"; }
                     if (Direction > 112.5 && Direction <= 157.5) { vient_De = " Sud Est"; }
                     if (Direction > 157.5 && Direction <= 202.5) { vient_De = "   Sud"; }
                     if (Direction > 202.5 && Direction <= 247.5) { vient_De = "Sud Ouest"; }
                     if (Direction > 247.5 && Direction <= 292.5) { vient_De = "  Ouest"; }
                     if (Direction > 292.5 && Direction <= 337.5) { vient_De = "Nord Ouest"; }                       
