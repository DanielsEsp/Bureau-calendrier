...
#define   EPD_BUSY 25 // violet - gris  
#define   EPD_RST  26 // blanc 
#define   EPD_DC   27 // vert
#define   EPD_CS   33 // orange
// SCL/SCK/CLK     14 // jaune
// SDA/DIN/MOSI    13 // bleu
...
const char* calendarURL = "votre url script day";
const char* calendarTomorrow = "votre url script day + 1";
int httpCode;
...
//   hspi.begin(HSPI_CLK, HSPI_MISO, HSPI_MOSI, HSPI_CS);
     hspi.begin(14, 12, 13, 33); // remap hspi for EPD (swap pins) !IMPORTANT
...
//   ESP RESTART, si Jour différent ou WiFi non connecté
